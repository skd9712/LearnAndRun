...
<head>
    <title>Title</title>
    <link rel="stylesheet" href="/resources/css/lecture_insert.css">
</head>
<body>
<div id="wrap">
    <h2>강의 등록</h2>
    <div class="line"></div>
    <form method="post" action="/lecture_insert_result">
        <ul>
            <li>
            ...
            <li>
                <label for="lectureData">강의자료</label>
                <input type="file" name="lectureData" id="lectureData">
            </li>
            <li>
