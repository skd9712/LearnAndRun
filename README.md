...
## 🥕 세부 구현 기능
**메인페이지**
  ![메인페이지](https://github.com/skd9712/LearnAndRun/assets/109783402/05ac2f06-5fee-4b2b-bafe-b02b1ef2988a)
  - 메인 페이지는 브랜드 컨셉에 맞는 감성적이고 활기찬 UI로 디자인 되어 있으며, 통합 검색 창과 과목별, 인기순, 최신순, 개강 임박 강의 등을 확인할 수 있다. 또한 캘린더를 통해 강의 일정을 확인할 수 있다.
  
**회원가입/로그인 기능**
  ![가입로그인](https://github.com/skd9712/LearnAndRun/assets/109783402/c7a9ba16-fd4d-472f-a6f6-96a08763ee6f)
  
**강의CRUD기능**
  ![강의CRUD](https://github.com/skd9712/LearnAndRun/assets/109783402/469d8cd2-1dab-417f-8bbe-3eb45f9f7961)
...
**찜기능**
  ![찜기능](https://github.com/skd9712/LearnAndRun/assets/109783402/b5404509-363d-4fd3-a0ba-43478f9dc626)
  - 비회원이 찜하기 버튼을 클릭하면 로그인 후 가능하다는 알림을 보여주고 회원이 찜하기 버튼을 클릭하면 찜목록 추가 혹은 삭제 여부 알림을 보여준다. 찜한 강의는 마이페이지에서 확인 가능하다.
  
**강의 결제 기능**
  ![결제기능](https://github.com/skd9712/LearnAndRun/assets/109783402/8ddee4d5-3055-4182-b654-1cf8f83ef33c)
  - 결제 버튼을 누르면 카카오페이 결제를 통해 간편 결제가 가능하며, 결제 완료 후 수강에 대한 권한을 부여 받고, 마이페이지>수강중인 강좌 목록에서 확인이 가능하다.
  
**마이페이지 기능**
  ![마이페이지](https://github.com/skd9712/LearnAndRun/assets/109783402/22fa51b1-8968-447b-8db1-f793836a9458)
  
**관리자페이지 기능**
  ![관리자페이지](https://github.com/skd9712/LearnAndRun/assets/109783402/d4f511e1-cd71-4ff0-a85f-8f93642bf1c5)
